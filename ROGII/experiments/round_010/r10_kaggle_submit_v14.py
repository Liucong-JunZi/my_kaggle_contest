"""ROGII Kaggle submission v14 — Hill climb v3 ensemble.

5-model ensemble matching round_010 hill climb v3 (perwell 7.566 OOF):
  PF 128-seed log-lik ensemble (init_spread=4.5)  weight 0.778
  P14 CatBoost (43-feat stack)                    weight 0.109
  P14 LightGBM (43-feat stack)                    weight 0.093
  P5  LightGBM (36-feat stack)                    weight 0.013
  XGBoost (43-feat stack, c06_xgb_default)        weight 0.007

Reference: experiments/round_010/results/hillclimb_runs/run_v3_with_c20-23.json

Wall budget on Kaggle: ~5-7h
  - Train PF features (16-seed) on 773 wells: ~2h
  - Train ML models (LGB×2, CAT, XGB): ~30 min
  - Test PF 128-seed on hidden test wells: ~25 min/100 wells
  - Test ML + blend: ~1 min

OOF→LB calibration (best estimate):
  v8: 9.91 OOF → 11.383 LB
  v14 OOF: 7.566 → predicted LB 8.5-8.7
"""
# %%
