...
intro = """# ROGII run v11 v50 final ensemble

Submit-ready run_v11 inference: PF128 + v10 TabICL raw offsets + selected ravaghi raw offsets + chesnikov v50 finalizer.
"""
